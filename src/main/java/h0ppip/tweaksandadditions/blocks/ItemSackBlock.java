...
public class ItemSackBlock extends DynGenBlock {
	private Item item;
	...
	public ItemSackBlock(Item item) {
		...
		this.identifier = new Identifier(TweaksAndAdditions.MOD_ID, this.itemIdentifier.getPath() + "_sack");
	}
		...
		switch (type) {
			case "block":
				return JsonUnbakedModel.deserialize("{\"parent\":\"" + namespace + ":block/item_sack\"," +
						"\"textures\":{\"particle\":\"" + namespace + ":block/" + path + "_top\"," +
